...
router.get('/last-balance', authMiddleware(['treasurer', 'auditor', 'chairman']), getLastBalance)

// Save period balance
router.post('/save-balance', authMiddleware(['treasurer']), saveBalance)

// Get all period balances (for history/debugging)
router.get('/all-balances', authMiddleware(['treasurer', 'auditor', 'chairman']), getAllBalances)
